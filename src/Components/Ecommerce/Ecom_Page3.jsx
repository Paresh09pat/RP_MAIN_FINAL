...
import news_pic from "../images1/Ecommerce_1-min.jpg"
import news_pic1 from "../images1/Ecommerce_2-min.jpg"
import news_pic2 from "../images1/Ecommerce_3-min.jpg"

function Ecommerce_Page3() {
    return (
        ...
        <section className="section3 bg-black" data-fss-anchor="view-2" id="Section3" data-snap-point data-index={3}>
            <div className="also_read_carousel ">
                <div className="section3_also_read_btn">
                    <h1 className="gradient_text section3_h1">Also Read </h1>
                                ...
                                <div className="carousel-inner">
                                    ...
                                    <div className="carousel-item">
                                        <div className="row">
                                            <div className="col-12" id="carousel_col_12">
                                                <div className="card mb-3" id="slider_card">
                                                    <img className="img-fluid111 slide" id="img-fluid" alt="100%x280" src={news_pic1} />
                                                    <div className="card-body" id="card-body">
                                    ...
                                    <div className="carousel-item">
                                        <div className="row">
                                            <div className="col-12" id="carousel_col_12">
                                                <div className="card mb-3" id="slider_card">
                                                    <img className="img-fluid111 slide" id="img-fluid" alt="100%x280" src={news_pic2} />
                                                    <div className="card-body " id="card-body">
                                                        <div className="card-content slide" id="card-content">
                                                            <h3 className="card-title" id="card-title"> RedPhantom Capital </h3>
                                                            <p className="card-text" id="card-text">
...
export default Ecommerce_Page3
